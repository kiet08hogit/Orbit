...
export default function ChatPage() {
 ...
 <Button size="sm" onClick={handleStartMeetup} disabled={isStartingMeetup}
 className="bg-indigo-600 hover:bg-indigo-700 text-primary-foreground h-7 text-xs px-3 rounded-full"
 >
 ...
 <Input placeholder="6-digit code" value={meetupVerificationCode}
 onChange={(e) => setMeetupVerificationCode(e.target.value.replace(/\D/g, '').slice(0, 6))}
 className="bg-secondary border-transparent focus-visible:ring-indigo-500 h-7 w-24 text-xs text-center rounded-full"
 maxLength={6}
 />
 <Button size="sm" onClick={handleVerifyMeetup}
 disabled={isVerifyingMeetup || meetupVerificationCode.length !== 6}
 className="bg-indigo-600 hover:bg-indigo-700 text-primary-foreground h-7 text-xs px-3 shrink-0 rounded-full"
 >
 ...
 <Button size="sm" onClick={handleMarkAsSold} disabled={isMarkingAsSold}
 className="bg-emerald-600 hover:bg-emerald-700 text-primary-foreground h-7 text-xs px-3 rounded-full"
 >
 ...
 <div className="flex items-center gap-2 ml-2 md:ml-4 md:border-l md:border-border md:pl-4">
 <Button size="sm" onClick={() => setShowBuyerMeetupModal(true)}
 className="bg-secondary hover:bg-foreground text-primary-foreground h-7 text-xs px-3 rounded-full shadow-sm"
 >
 Show Code
 </Button>
 </div>
 ...
 >
 <div className="flex-1 rounded-full border border-border flex items-center px-4 min-h-[44px] bg-card">
 <Input
 placeholder="Message..."
 className="flex-1 bg-transparent border-transparent focus-visible:ring-0 text-[15px] h-[40px] px-0 shadow-sm placeholder:text-muted-foreground"
 value={newMessage}
