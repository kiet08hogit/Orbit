...
export default function WishlistPage() {
 ...
 <h1 className="text-[32px] font-semibold tracking-tight text-foreground">Your Wishlist</h1>
 </div>
 </div>
 ...
 <h3 className="text-[22px] font-semibold text-foreground mb-2">Your Wishlist is Empty</h3>
