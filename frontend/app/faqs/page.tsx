  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-5xl px-6 py-24 md:py-32 flex flex-col gap-12">
        ...
        <h1 className="text-[56px] md:text-[72px] font-semibold text-zinc-900 tracking-tighter leading-[1.07] mb-4">
          Features & FAQs
        </h1>
        
        <p className="text-[21px] md:text-[28px] text-zinc-900 font-normal leading-[1.14] tracking-tight max-w-2xl mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="w-full bg-white rounded-[18px] border border-[#e0e0e0] shadow-sm p-8 flex flex-col gap-4 hover:-translate-y-1 transition-transform duration-300">
            ...
            <h2 className="text-[28px] font-semibold text-zinc-900 tracking-tight leading-tight">Verified Students Only</h2>
          ...
          <div className="w-full bg-zinc-50 rounded-[18px] shadow-sm p-8 flex flex-col gap-4 hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="w-full bg-white rounded-[18px] border border-[#e0e0e0] shadow-sm p-8 flex flex-col gap-4 hover:-translate-y-1 transition-transform duration-300">
            ...
            <h2 className="text-[28px] font-semibold text-zinc-900 tracking-tight leading-tight">Local Campus Listings</h2>
            <p className="text-[17px] text-[#7a7a7a] leading-[1.47] font-normal">
          ...
          <div className="w-full bg-white rounded-[18px] border border-[#e0e0e0] shadow-sm p-8 flex flex-col gap-4 hover:-translate-y-1 transition-transform duration-300">
            ...
            <h2 className="text-[28px] font-semibold text-zinc-900 tracking-tight leading-tight">Swipe to Match</h2>
            <p className="text-[17px] text-[#7a7a7a] leading-[1.47] font-normal">
        ...
        <div className="w-full flex flex-col gap-6 mt-16">
          <h2 className="text-[40px] font-semibold text-zinc-900 tracking-tighter leading-[1.07] mb-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="w-full bg-white rounded-[18px] border border-[#e0e0e0] shadow-sm p-6">
              <h3 className="text-[21px] font-semibold text-zinc-900 tracking-tight mb-2">Is the platform free?</h3>
            ...
            <div className="w-full bg-white rounded-[18px] border border-[#e0e0e0] shadow-sm p-6">
              <h3 className="text-[21px] font-semibold text-zinc-900 tracking-tight mb-2">How does it work?</h3>
              <p className="text-[17px] text-[#7a7a7a] font-normal leading-[1.47]">
            ...
            <div className="w-full bg-white rounded-[18px] border border-[#e0e0e0] shadow-sm p-6">
              <h3 className="text-[21px] font-semibold text-zinc-900 tracking-tight mb-2">What if I don&apos;t have a .edu email?</h3>
              <p className="text-[17px] text-[#7a7a7a] font-normal leading-[1.47]">
            ...
            <div className="w-full bg-white rounded-[18px] border border-[#e0e0e0] shadow-sm p-6">
              <h3 className="text-[21px] font-semibold text-zinc-900 tracking-tight mb-2">How do payments work?</h3>
              <p className="text-[17px] text-[#7a7a7a] font-normal leading-[1.47]">
