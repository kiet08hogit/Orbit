  ...
  return (
    <div className="min-h-screen bg-background dark:bg-card font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-5xl px-6 py-24 md:py-32 flex flex-col gap-12">
        <Link
          href="/"
          className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors w-fit font-normal text-[17px]"
        >
        ...
        <div className="w-full flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="w-full bg-card rounded-[18px] border border-border shadow-sm p-6">
              <h3 className="text-[21px] font-semibold text-foreground tracking-tight mb-2">
            ...
            <div className="w-full bg-card rounded-[18px] border border-border shadow-sm p-6">
              ...
              <p className="text-[17px] text-muted-foreground font-normal leading-[1.47]">
                ...
                <strong>Direct Payment:</strong> You arrange payment entirely on
                your own (cash, Zelle, Venmo) when you meet the seller.{" "}
                <strong>Secure Payment:</strong> Handled seamlessly inside Orbit
