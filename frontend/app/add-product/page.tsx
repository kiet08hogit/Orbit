...
export default function AddProductPage() {
 ...
 <Link
 href="/listings"
 className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mb-6 text-[14px] font-medium"
 >
 ...
 {/* Form Card */}
 <div className="bg-card border border-border rounded-[20px] p-6 md:p-8 shadow-sm">
 {error && (
 ...
 <label className="text-[13px] font-semibold text-foreground">Upload Image</label>
 <div className="relative w-full border-2 border-dashed border-zinc-300 rounded-[14px] p-8 flex flex-col items-center justify-center hover:bg-secondary hover:border-[#0066cc] transition-colors group cursor-pointer">
 <input
 ref={fileInputRef}
 type="file"
 accept="image/*"
 ...
 />
 <UploadCloud className="h-8 w-8 text-muted-foreground group-hover:text-[#0066cc] transition-colors mb-3" />
 <p className="text-[14px] text-muted-foreground mb-1 text-center">Drag and drop your image here, or click to select a file</p>
 <p className="text-[12px] text-muted-foreground text-center">(Only *.jpeg, *.jpg, *.png images will be accepted)</p>
 </div>
 ...
 className="relative h-20 w-20 flex-shrink-0 rounded-2xl overflow-hidden border border-border group bg-secondary"
 >
 <img src={img.url} alt={`Upload ${idx + 1}`} className="w-full h-full object-cover" />
 {idx === 0 && (
 <div className="absolute top-1 left-1 bg-foreground/70 text-primary-foreground text-[9px] font-bold px-1.5 py-0.5 rounded-md uppercase tracking-wider">
 Cover
 </div>
 )}
 <button
 ...
 <div className="space-y-2">
 <label className="text-[13px] font-semibold text-foreground">Location</label>
 <Input
 name="location"
 value={formData.location}
 onChange={handleChange}
 placeholder="e.g. East Campus, Student Center..."
 className="w-full h-12 rounded-[14px] px-4 text-[14px] bg-secondary border-border focus-visible:ring-[#0066cc] focus-visible:ring-1"
 />
 </div>
 </div>
 ...
 <div className="space-y-2">
 <label className="text-[13px] font-semibold text-foreground">Material</label>
 <Input
 name="material"
 ...
 <span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground font-semibold text-[14px]">$</span>
 <Input
 required
 type="number"
 step="0.01"
 ...
 onChange={handleChange}
 placeholder="0.00"
 className="w-full h-12 rounded-[14px] pl-8 pr-4 text-[14px] bg-secondary border-border focus-visible:ring-[#0066cc] focus-visible:ring-1"
 />
 </div>
 </div>
 ...
 className="w-full min-h-[120px] rounded-[14px] p-4 text-[14px] bg-secondary border-border focus-visible:ring-[#0066cc] focus-visible:ring-1 resize-none"
 />
 </div>

 {/* ── Payment Settings ── */}
 <div className="space-y-3 pt-2">
 <label className="text-[13px] font-semibold text-foreground">Payment Options</label>
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 {/* Direct Payment */}
 <div className={`border-[1.5px] rounded-[14px] p-4 cursor-pointer transition-all ${formData.acceptsDirectPayment ? 'border-[#0066cc] bg-[#0066cc]/5' : 'border-border bg-card hover:border-zinc-300'}`}
 onClick={() => setFormData(prev => ({ ...prev, acceptsDirectPayment: !prev.acceptsDirectPayment }))}
 >
 <div className="flex items-center justify-between mb-1">
 <span className="font-semibold text-foreground text-[14px]">Direct Payment</span>
 ...
 {formData.acceptsDirectPayment && <div className="h-2 w-2 bg-card rounded-full" />}
 </div>
 </div>
 <p className="text-[12px] text-muted-foreground">Cash, Zelle, Venmo at meetup.</p>
 </div>

 {/* Protected Payment */}
 <div className={`border-[1.5px] rounded-[14px] p-4 cursor-pointer transition-all relative overflow-hidden ${formData.acceptsProtectedPayment ? 'border-emerald-500 bg-emerald-50' : 'border-border bg-card hover:border-zinc-300'}`}
 onClick={() => {
 if (!isStripeLinked) {
 ...
 <div className="flex items-center justify-between mb-1">
 <span className="font-semibold text-foreground text-[14px] flex items-center gap-1.5">
 Protected Payment
 </span>
 ...
 {formData.acceptsProtectedPayment && <div className="h-2 w-2 bg-card rounded-full" />}
 </div>
 </div>
 <p className="text-[12px] text-muted-foreground">Card payments via Orbit Escrow.</p>
