          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative w-full border-2 border-dashed border-zinc-300 rounded-[14px] p-8 flex flex-col items-center justify-center hover:bg-secondary hover:border-[#0066cc] transition-colors group cursor-pointer">
                ...
                <p className="text-[14px] text-muted-foreground mb-1 text-center">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground font-semibold text-[14px]">
                  $
                </span>
                <Input
                  required
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {/* Direct Payment */}
                <div
                  className={`border-[1.5px] rounded-[14px] p-4 cursor-pointer transition-all ${formData.acceptsDirectPayment ? "border-[#0066cc] bg-[#0066cc]/5" : "border-border bg-card hover:border-zinc-300"}`}
                  onClick={() =>
                    setFormData((prev) => ({
                      ...prev,
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div
                      className={`h-[18px] w-[18px] rounded-full border-2 flex items-center justify-center transition-colors ${formData.acceptsDirectPayment ? "border-[#0066cc] bg-[#0066cc]" : "border-zinc-300"}`}
                    >
                ...
                {/* Protected Payment */}
                <div
                  className={`border-[1.5px] rounded-[14px] p-4 cursor-pointer transition-all relative overflow-hidden ${formData.acceptsProtectedPayment ? "border-emerald-500 bg-emerald-50" : "border-border bg-card hover:border-zinc-300"}`}
                  onClick={() => {
                    if (!isStripeLinked) {
                      setError(
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <div
                      className={`h-[18px] w-[18px] rounded-full border-2 flex items-center justify-center transition-colors ${formData.acceptsProtectedPayment ? "border-emerald-500 bg-emerald-500" : "border-zinc-300"}`}
                    >
                  ...
                  {!isStripeLinked && !isLoadingStripeStatus && (
                    <div
                      className="mt-2 text-[11px] font-semibold text-[#0066cc] hover:underline"
                      onClick={(e) => {
                        e.stopPropagation();
