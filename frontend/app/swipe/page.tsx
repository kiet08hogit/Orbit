          ...
          {activeListing ? (
            <>
              ...
              {nextListing && (
                <motion.div
                  key={nextListing.id}
                  className="absolute inset-0 z-0 flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm border border-zinc-200"
              ...
              <motion.div
                ...
                className="absolute inset-0 z-10 flex cursor-grab active:cursor-grabbing flex-col overflow-hidden rounded-2xl bg-white shadow-2xl border border-zinc-200/60"
            ...
            <motion.div 
              ...
              className="flex h-full w-full flex-col items-center justify-center rounded-2xl border-2 border-dashed border-zinc-300 bg-white shadow-sm p-8 text-center"
            >
