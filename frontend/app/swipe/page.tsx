        ...
        <div className="flex-1 flex flex-col items-center justify-center min-h-[700px] relative">
          ...
          <div className="absolute top-0 text-center z-20">
            <h1 className="text-2xl font-black text-foreground tracking-tight flex items-center justify-center gap-2">
              <AuroraText colors={["#3252DF", "#6366F1", "#A855F7", "#3b82f6"]}>
                Match Your Needs
              </AuroraText>
            </h1>
            ...
            <AnimatePresence>
              {activeListing ? (
                  ...
                  {nextListing && (
                    ...
                    >
                      <div className="relative flex-1 bg-secondary">
                        <img
                          src={
                            nextListing.images && nextListing.images.length > 0
                      ...
                      <div className="p-6 bg-card flex flex-col justify-end h-[40%]">
                        <div className="flex justify-between items-start mb-2">
                          <h2 className="text-2xl font-black text-foreground truncate pr-2">
                            {nextListing.title}
                          </h2>
                          <span className="text-2xl font-black text-[#3252DF]">
                            ${nextListing.price}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="relative flex h-full w-full flex-col overflow-hidden rounded-[24px] bg-card shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-border">
                        ...
                        <div className="relative flex-1 bg-secondary overflow-hidden">
                          ...
                          <div className="absolute top-4 left-4 z-20">
                            <Badge
                              variant="outline"
                              className="bg-card/90 backdrop-blur-md text-foreground border-transparent font-bold px-3 py-1 text-xs shadow-sm uppercase tracking-wider"
                            >
                        ...
                        <div className="p-6 bg-card relative z-20 border-t border-border">
                          <div className="flex justify-between items-start mb-3 gap-2">
                            ...
                            <span className="text-2xl font-black text-[#3252DF] shrink-0">
                              ${activeListing.price}
                            </span>
                          </div>
                ...
                >
                  ...
                  <Button
                    variant="outline"
                    className="mt-6 font-bold rounded-full border-border"
